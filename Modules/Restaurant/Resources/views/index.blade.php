...
@section('title')
    <title>{{ __('translate.Restaurant List') }}</title>
@endsection

@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('translate.Restaurant List') }}</h3>
    <p class="crancy-header__text">{{ __('translate.Manage Restaurant') }} >> {{ __('translate.Restaurant List') }}</p>
@endsection
                                ...
                                <div class="crancy-customer-filter">
                                    <div class="crancy-customer-filter__single crancy-customer-filter__single--csearch d-flex items-center justify-between create_new_btn_box">
                                        <div class="crancy-header__form crancy-header__form--customer create_new_btn_inline_box">
                                            <h4 class="crancy-product-card__title">{{ __('translate.Restaurant List') }}</h4>

                                            <a href="{{ route('admin.restaurants.create') }}" class="crancy-btn ">
                                            <span>
                                            ...
                                            @foreach ($restaurants as $index => $restaurant)
                                                <tr class="odd">
                                                  ...
                                                  <td class="crancy-table__column-2 crancy-table__data-2">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title">{{ html_decode($restaurant?->city?->translate?->name) }}</h4>
                                                    </td>
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <label class="crancy__item-switch">
                                                            <input {{ $restaurant->is_trusted == 1 ? 'checked' : '' }}  name="is_trusted" type="checkbox" onclick="manageStatus({{ $restaurant->id }})">
    ...
    <script>
        ...
        function manageStatus(id){
            ...
            $.ajax({
                ...
                url:"{{url('/admin/restaurant/trusted-status') }}"+"/"+id,
