...
<div class="doc-section" id="generate-pdf">
    ...
    <p>
        This endpoint allows you to retrieve or display the official 
        <strong>e-Invoice PDF</strong> generated by MySyncTax.
    </p>

    <h3>Endpoint</h3>
    <div class="code-block">
        <pre>GET {{url('')}}/invoice/view/{mysynctax_uuid}</pre>
    </div>

    <h3>Description</h3>
    <ul>
        <li>Returns a rendered <strong>PDF invoice</strong></li>
        <li>Based on <strong>mysynctax_uuid</strong> from API response</li>
        <li>Used for download, preview, or printing</li>
    </ul>

    <h3>Example</h3>
    <div class="code-block">
        <pre>{{url('')}}/invoice/view/5a59f5ba7a4f65b47b844ae6671c833c0d5c8b16</pre>
    </div>

    <h3>How to Use</h3>
    <ul>
        <li>Step 1: Submit invoice via API</li>
        <li>Step 2: Get <code>mysynctax_uuid</code> from response</li>
        <li>Step 3: Open the PDF using this endpoint</li>
    </ul>
    ...
    <div class="code-block">
<pre>
window.open("{{url('')}}/invoice/view/" + mysynctax_uuid);
</pre>
    </div>

    <h4>Download using PHP</h4>
    <div class="code-block">
<pre>
$pdfUrl = "{{url('')}}/invoice/view/" . $mysynctax_uuid;
header("Location: " . $pdfUrl);
exit;
</pre>
    </div>

    <h4>Download using JavaScript</h4>
    <div class="code-block">
<pre>
fetch("{{url('')}}/invoice/view/" + mysynctax_uuid)
  .then(res => res.blob())
  .then(blob => {
    ...
    <h3>Notes</h3>
    <ul>
        <li>No authentication required (public access via UUID)</li>
        <li>Ensure UUID is valid</li>
        <li>PDF includes QR code and LHDN validation details</li>
    </ul>
