...
<div class="container-fluid">
    ...
    <!-- ⭐ FIX: White Panel using Bootstrap Card ⭐ -->
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="country_subentity_code" id="country_subentity_code" class="form-control" required>
                        ...
                        <option value="14" {{ old('country_subentity_code') == '14' ? 'selected' : '' }}>Kuala Lumpur</option>
                        <option value="15" {{ old('country_subentity_code') == '15' ? 'selected' : '' }}>Labuan</option>
                        <option value="16" {{ old('country_subentity_code') == '16' ? 'selected' : '' }}>Putrajaya</option>
                    </select>
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" 
                           value="{{ $connection->mysynctax_key ?? '' }}" readonly>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control"
                           value="{{ $connection->mysynctax_secret ?? '' }}" readonly>
                    <small class="text-muted">Auto-generated</small>
                </div>
