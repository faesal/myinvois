...
<body class="p-4">
    <div class="container border p-4">
        ...
        <div class="text-end">
         ...
         <div class="text-center mt-4">
            <form action="{{ url('show/' . $customer->id_customer) }}" method="POST" id="submitForm">
                @csrf
    ...
    <!-- jQuery script for QR and Submit Button -->
    <script>
        $(document).ready(function () {
            // Form Submit Button Disable + Spinner
            ...
            fetch(`https://mysynctax.com/einvoice/public/qr_link/${uuid}`)
                ...
                .then(generatedLink => {
                    QRCode.toCanvas(document.getElementById('canvas'), generatedLink.trim(), {
                        width: 200,
