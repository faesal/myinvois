...
<div class="container py-4">
    ...
    <div class="mt-4 text-center">
        <button id="btnGeneratePDF" class="btn btn-primary shadow-sm">
            <i class="ph-file-pdf me-2"></i> Download PDF
        </button>
    </div>
...
<script>
    ...
    // Generate QR Code if UUID exists
    if(uuid) {
    ...
    $('#btnGeneratePDF').on('click', function () {
        ...
        html2pdf().set({
            ...
            html2canvas: { 
                scale: 2, 
                scrollY: 0,
                useCORS: true // Essential for loading external images (LHDN logo)
            },
