...
class CreditNoteController extends Controller
{
    ...
    public function test_credit_note(){
    ...
    public function listing(Request $request)
    {
        ...
        $query = DB::table('invoice')
            ...
            ->where('invoice.invoice_type_code', '02'); // Credit Note only
        ...
        $total = DB::table('invoice')->where('invoice_type_code', '02')->count();
        $submitted = DB::table('invoice')
            ->where('invoice_type_code', '02')
    ...
    public function store(Request $request)
    {
        ...
        $creditNoteId = DB::table('invoice')->insertGetId([
            'unique_id' => $unique_id,
            'invoice_no' => 'CREDIT_NOTE-' . now()->format('YmdHis'),
            'invoice_type_code' => '02', // Credit Note
            'issue_date' => now(),
